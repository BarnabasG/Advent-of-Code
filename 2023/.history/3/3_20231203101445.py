...
def get_number(line, index, found_indexes):
        ...
        for neighbor in neighbors:
            try:
                if lines[coord[0] + neighbor[0]][coord[1] + neighbor[1]].isdigit():
                    ...
                    _answer, _found_indexes = get_number(lines[coord[0] + neighbor[0]], coord[1] + neighbor[1], found_indexes)
                    print(_answer, _found_indexes)
                    answer += _answer
